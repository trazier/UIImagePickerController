...
//  Homework2
//
//  Created by Frazier Moore on 2/20/14.
//  Copyright (c) 2014 Frazier Moore. All rights reserved.
//

#import "EditPostViewController.h"

@interface EditPostViewController () <UIImagePickerControllerDelegate, UINavigationControllerDelegate, UIActionSheetDelegate>
...
- (IBAction)saveThePost:(id)sender
{
    ...
    _post.title = self.titleLabel.text;
